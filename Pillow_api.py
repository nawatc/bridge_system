...
from porter_bridges.porter_bridges import get_hcp_from_text ,dict_to_text
...
def make_pic_4hand(input_dict_desk) :
    ...
    # Return Image
    # ref. https://stackoverflow.com/questions/34697559/pil-image-to-qpixmap-conversion-issue
    return pic_4hand
