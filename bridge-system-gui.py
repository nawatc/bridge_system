...
from Pillow_api import make_pic_4hand
from PIL.ImageQt import ImageQt

from sqlite3_api import Database

from PyFPDF_api import PDF
...
class MyTabsWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        """
            # Loading image to Program      # Legacy
        ...
        self.pilimage = ImageQt(make_pic_4hand({}))
        self.pixmap = QPixmap.fromImage(self.pilimage)
    ...
    def Display_board(self ,pbn_desk):
        ...
        """
        # Loading image
        self.pilimage = ImageQt(make_pic_4hand(input_text))
        self.pixmap = QPixmap.fromImage(self.pilimage)
        self.label_pic.setPixmap(self.pixmap)
    ...
    def clicked_random_plot_table(self):
        ...
        """
        # Lock Maximum Desk Number to 9999
        if num_desk > 9999:
            num_desk = 9999
        """
